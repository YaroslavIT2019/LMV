...
{
    public partial class Form_1_1_4 : Form
    {
        ...
        {
            InitializeComponent();
            textBox1.MaxLength = 16;  // можна вписувати максимум 16 символів
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            inf.MessageToFile(inf.path_conf, "Перейти до головного меню з меню переказу на іншу карту?");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (count <= balance)
            {
                stat.SetStatistics(4, DateTime.Now);
            ...
            {
                inf.MessageToFile(inf.path_mess, "На карті недостатньо грошей для здійснення операції переведення грошей на іншу картку");
